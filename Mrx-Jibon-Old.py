...
----------------------------------------------
 Author    : JIBON ISLAM
 Github    : MRXJIBON
 Facebook  : J  I  B  O  N  ツ
 Tool Name : MRX JIBON 
 Type type : PAID
 Version   : 1.9.9
----------------------------------------------
 MRX JIBON version 1.9.9
 For Haters: Tumhare Okat Nhi Mere JIBON chodne Ke 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/IruRGeLlCOx8dJCfd81R5q');menu()
                        elif xd in ['7','07']:
                        ...
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid MRX JIBON Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                       ...
                       'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-P200) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5647.210 Mobile Safari/537.36',
                       'viewport-width': '980',}
